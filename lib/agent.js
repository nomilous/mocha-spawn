...
var debug = require('debug')('mocha-fork:agent');
...
function Agent(options) {
  ...
  Object.defineProperty(this, 'apiKeyWait', {
    value: options.apiKeyWait || 10000
  });
...
Agent.prototype.start = start;

Agent.prototype._ensureCertificate = _ensureCertificate;
Agent.prototype._startServer = _startServer;
Agent.prototype._configureServer = _configureServer;
Agent.prototype._onConnection = _onConnection;
